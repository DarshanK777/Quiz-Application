...
public class Instructions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("1.ONLY 5 Questions Can be Entered");

        jLabel3.setText("2. Question entered Once can be remodifed through Last page only");

        jLabel4.setText("3.Last page(s) shows the entered Questions");
